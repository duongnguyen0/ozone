...
public class DefaultSecretKeyVerifierClient implements SecretKeyVerifierClient {
  ...
  public static DefaultSecretKeyVerifierClient create(
      SecurityConfig securityConfig, ConfigurationSource conf)
      throws IOException {
    SCMSecurityProtocol securityProtocol = getScmSecurityClientWithMaxRetry(
